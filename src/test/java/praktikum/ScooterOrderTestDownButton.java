...
public class ScooterOrderTestDownButton {
    ...
    @Test
        public static void main(String[] args) {
            ...
            for (WebElement option : options) {
                if (option.getText().equals("Савёловская")) {
                    option.click();
                    break;
                }
            }
            ...
            phoneInput.sendKeys("+79888888888");
            ...
            commentForCourier.sendKeys("Звонить бесполезно.Пишите!");;
